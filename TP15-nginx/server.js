...
const minimist = require('./src/minimist/minimist.js')
...
app.get('/info', async(req, res) => {
    ...
    const processNum = require('os').cpus().length

    const info = { processId, nodeVersion, operativeSystem, usedMemory, currentPath, processNum }
